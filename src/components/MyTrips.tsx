      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {trips.map((trip) => (
          <motion.div
            ...
            className="group relative bg-brand-surface/50 backdrop-blur-sm border border-brand-border rounded-2xl overflow-hidden hover:border-brand-accent transition-all cursor-pointer hover:shadow-xl hover:shadow-blue-500/5"
          >
            {trip.hero_image && (
              <div className="w-full h-32 overflow-hidden border-b border-brand-border">
                <img 
                  src={trip.hero_image} 
            ...
            <div className="p-6 space-y-4">
              <div className="flex justify-between items-start">
                <div className="space-y-1">
                  ...
                  <h3 className="text-lg font-display font-bold text-brand-text-primary group-hover:text-brand-accent transition-colors line-clamp-1">
